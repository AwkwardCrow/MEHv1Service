...
namespace MEHv1.Web
{
  public class CustomBootstrapper : DefaultNancyBootstrapper
  {
    protected override void ConfigureApplicationContainer(TinyIoCContainer container)
    {
      ...
      ResourceViewLocationProvider.RootNamespaces.Add(Assembly.GetAssembly(typeof(MainModule)), "MEHv1.Web.Views");
    }
    ...
    protected override void ConfigureConventions(NancyConventions conventions)
    {
      ...
      conventions.StaticContentsConventions.Add(AddStaticResourcePath("/content", Assembly.GetAssembly(typeof(MainModule)), "MEHv1.Web.Views.content"));
    }
